...
function MintFungibleToken() {
  ...
  const handleSubmit = async event => {
    ...
    toast.info(
      `Creating token with name: ${payload.name}, symbol: ${payload.symbol} and initial supply of ${payload.supply} tokens`
    );
    ...
    toast.success(
      `Successfully created ${payload.name} (${payload.symbol}) token`
    );
