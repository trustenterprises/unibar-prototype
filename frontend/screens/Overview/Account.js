...
function Account() {
  ...
  const copyToClipboard = () => {
    ...
    toast.info(
      `Copied explorer url to clipboard for user: ${account.hedera_id}`
    );
  };
      ...
      <div className="cursor-pointer rounded-md shadow-lg bg-white relative">
        <div className="py-5">
          <div className="px-6">
            ...
            <p className="text-sm leading-none text-justify text-gray-800 mt-1">
              Testnet
            </p>
          </div>
          ...
          <div
            className="mt-5 px-6 flex  items-center"
          ...
          <div className="mt-4 px-6 flex flex-col w-full justify-center items-center">
            ...
            <p className="text-sm font-bold leading-none text-gray-700 mt-2">
              {account.hedera_id}
            </p>
          </div>
        </div>
