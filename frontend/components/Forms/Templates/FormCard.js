              ...
              <div className="my-8 mx-auto xl:w-full xl:mx-0">
                  ...
                  <div className="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="email"
                        required
                        className="w-full text-gray-800 focus:outline-none  focus:border focus:border-indigo-700 font-normal py-3 flex items-center pl-16 text-sm border-green-400 rounded border shadow"
                  ...
                  <div className="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                    ...
                    <div className="border border-gray-300 shadow-sm rounded flex relative">
                      <select
                        ...
                        required
                        id="City"
                        className="bg-transparent appearance-none z-10 pl-3 py-3 w-full text-sm border border-transparent focus:outline-none focus:border-indigo-700 text-gray-800 rounded">
                ...
                <div className="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                  ...
                  <input
                    ...
                    id="ZIP"
                    name="zip"
                    className="border border-red-400 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 text-gray-800"
