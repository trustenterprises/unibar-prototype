      ...
      <div className="xl:w-5/12 w-11/12 mx-auto mb-4 my-6 md:w-2/3 shadow sm:px-10 sm:py-6 py-4 px-4 bg-white rounded-md">
        ...
        <div className="flex flex-col items-start sm:items-center sm:flex-row mt-4">
          <div className="relative w-full sm:w-2/3">
            ...
            <input
              id="email"
              className="py-3 stext-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full pl-16 text-sm border-gray-300 rounded border shadow"
              placeholder="youremail@example.com"
            />
          </div>
          <button className="mt-4 sm:mt-0 sm:ml-4 focus:outline-none bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm">
            Submit
          </button>
        </div>
      </div>
