...
test("The HashgraphClient should throw if network is in correct", () => {
  expect(() => {
    ...
    'Network from environment badnetwork could not match for any hedera network. Change your "HEDERA_NETWORK" environment variable to either: "testnet", "previewnet" or "mainnet"'
  );
});
